				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-8 offset-lg-2 animate" data-animation="scaleAppear">
							...
							<form class="form-wizard" id="regForm" action="controller/ajoutdevis.php" method="post">
                      <div class="tab">
                        <div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text" placeholder="nom service" required="required" name="nomservice">
                        </div>

                        <div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text" placeholder="nom client" required="required" name="nomclient">
                        </div>

						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text" placeholder="e-mail" required="required" name="email">
                        </div>
						<div class="form-group">
                          <label for="name"></label>
						...
						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text" placeholder="téléphone" required="required" name="telephone">
                        </div>
						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="date" placeholder="deadline" required="required" name="deadline">
                        </div>
