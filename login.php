...
<!-- Mirrored from html.modernwebtemplates.com/dotcreative/shop-account-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Dec 2021 20:49:37 GMT -->
<head>
...
<br>
			...
			-->
										...
										<form class="woocomerce-form woocommerce-form-login login form-control1" method="post" action="controller/verifclient.php">
											<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
												<label for="username">
												</label>
												<input type="email" class="woocommerce-Input woocommerce-Input--text input-text" name="email" id="username" placeholder="email" value="">
											</p>
											<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
												<label for="password">
												</label>
											...
											<p class="woocommerce-LostPassword lost_password">
												<a href="ajout-client.php">Vous n'avez pas un compte?</a>
											</p>
