				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-8 offset-lg-2 animate" data-animation="scaleAppear">
							...
							<form class="form-wizard" id="regForm" action="controller/modifdevis.php?id=<?php echo $donnees['id'];?>" method="post">
                      <div class="tab">
                        <div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text"  required="required" name="nomservice" value="<?php echo $donnees['nomservice'] ?>">
                        </div>

                        <div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text"  required="required" name="nomclient" value="<?php echo $donnees['nomclient'] ?>">
                        </div>

						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text"  required="required" name="email" value="<?php echo $donnees['email'] ?>">
                        </div>
						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text"  required="required" name="adresse" value="<?php echo $donnees['adresse'] ?>">
                        </div>
						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text"  required="required" name="telephone" value="<?php echo $donnees['telephone'] ?>">
                        </div>
						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="date"  required="required" name="deadline" value="<?php echo $donnees['deadline'] ?>">
                        </div>
						...
						<div class="row">
							<div class="col-sm-12 text-center mt-15">
								<div class="form-group">
									<button type="submit" id="contact_form_submit" name="contact_submit" class="btn btn-maincolor">Modifier
									</button>
								</div>
							</div>
