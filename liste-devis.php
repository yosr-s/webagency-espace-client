				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-8 offset-lg-2 animate" data-animation="scaleAppear">
							...
							<a href="ajout-devis.php">
							<button type="button" class="btn btn-maincolor">Ajouter devis</button>
                            </a>
							...
							<?php 
									...
									<table class="table table-stripped">
										...
										?>
											...
											<td><a href="modif-devis.php?id=<?php echo $donnees['id']; ?>" class="btn btn-primary">Modifier</a>
                             <span class="btn btn-danger">
                             <a href="controller/suppdevis.php?id=<?php echo $donnees['id']; ?>" style="color: #fff;">supprimer</a>
                            </span>
							<a href="invoice.php?id=<?php echo $donnees['id']; ?>" class="btn btn-maincolor2">PDF</a></td>
