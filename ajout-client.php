				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-8 offset-lg-2 animate" data-animation="scaleAppear">
							...
							<form class="form-wizard" id="regForm" action="controller/ajoutclient.php" method="post">
                      <div class="tab">
                        ...
                        <div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text" placeholder="raison_sociale" required="required" name="raison_sociale">
                        </div>
						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text" placeholder="adresse" required="required" name="adresse">
                        </div>
						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text" placeholder="matricule_fiscale" required="required" name="matricule_fiscale">
                        </div>
						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="text" placeholder="telephone" required="required" name="telephone">
                        </div>
						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="email" placeholder="email" required="required" name="email">
                        </div>
						<div class="form-group">
                          <label for="name"></label>
                          <input class="form-control" id="name" type="password" placeholder="password" required="required" name="password">
                        </div>
						...
						<div class="row">
							<div class="col-sm-12 text-center mt-15">
								<div class="form-group">
									<button type="submit" id="contact_form_submit" name="contact_submit" class="btn btn-maincolor">Creer
									</button>
								</div>
							</div>
